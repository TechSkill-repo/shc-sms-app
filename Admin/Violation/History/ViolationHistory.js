...
import SearchForm from "./ViolationSearch";
  ...
  const searchFsgr = async () => {
    ...
    try {
      const response = await axios.get(
        `${serveraddress}violation/${selectedYear.value}/${selectedMonth.value}/${selectedLocation.label}`
      );
  ...
  return (
    ...
    >
      <Appbar.Header>
        ...
        />
        <Appbar.Content title="Violation History" />
        <Appbar.Action
          icon="magnify"
          onPress={() => {
        ...
        <View style={styles.mainContainer}>
          ...
          {loading ? (
            ...
            >
              ...
              >
                Search your Required Violations
              </Text>
              <TouchableOpacity
                onPress={() => {
                  setShowSearch((prevState) => !prevState);
