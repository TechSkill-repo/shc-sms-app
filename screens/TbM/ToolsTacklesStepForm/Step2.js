...
const Step2 = ({
  ...
  const handleAddInput = () => {
    ...
    const exists = inputList.some(
      (item) => item.toolName === "" && item.condition === ""
    );
    if (!exists) {
  ...
  const handleRemoveInput = (idToRemove) => {
    ...
    const updatedTools = formData.toolsName
      ? formData.toolsName.filter((item) => item.id !== idToRemove)
      : [];
  ...
  const handleInputChange = (text, id, field) => {
    ...
    const updatedTools = updatedList
      ...
      .map((item) => ({
        ...
        tpi: item.tpi.trim(),
        deformation: item.deformation.trim(),
        auditDoneBy: item.auditDoneBy.trim(),
      }))
      .filter(Boolean);
          ...
          >
            ...
            >
              <TextInput
                ...
                value={input.text}
                onChangeText={(text) =>
                  handleInputChange(text, input.id, "toolName")
                }
              ...
              {seeMore && (
                ...
                >
                  <TextInput
                    ...
                    value={input.text}
                    onChangeText={(text) =>
                      handleInputChange(text, input.id, "tpi")
                    }
                  ...
                  <TextInput
                    ...
                    value={input.text}
                    onChangeText={(text) =>
                      handleInputChange(text, input.id, "deformation")
                    }
                  ...
                  <TextInput
                    ...
                    value={input.text}
                    onChangeText={(text) =>
                      handleInputChange(text, input.id, "auditDoneBy")
                    }
