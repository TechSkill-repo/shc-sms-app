  ...
  const searchFsgr = async () => {
    ...
    try {
      const response = await axios.get(
        `${serveraddress}forms/tools-tackles/${selectedYear.value}/${selectedMonth.value}/${selectedLocation.label}`
      );
  ...
  return (
    ...
    >
      <Appbar.Header>
        ...
        />
        <Appbar.Content title="Tools Tackles" />
        <Appbar.Action
          icon="magnify"
          onPress={() => {
        ...
        <View style={styles.mainContainer}>
          ...
          {loading ? (
            ...
            >
              ...
              >
                Please Search your Required TNT
              </Text>
              <TouchableOpacity
                onPress={() => {
                  setShowSearch((prevState) => !prevState);
...
export default ToolsAndTackles;
