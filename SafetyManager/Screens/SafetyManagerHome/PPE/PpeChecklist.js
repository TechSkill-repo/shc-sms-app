...
import SearchForm from "./PpeSearch";
  ...
  const searchFsgr = async () => {
    ...
    try {
      const response = await axios.get(
        `${serveraddress}forms/ppe-checklist/${selectedYear.value}/${selectedMonth.value}/${selectedLocation.label}`
      );
        ...
        <View style={styles.mainContainer}>
          ...
          {loading ? (
            ...
            >
              ...
              >
                Please Search your Required PPE
              </Text>
              <TouchableOpacity
                onPress={() => {
                  setShowSearch((prevState) => !prevState);
